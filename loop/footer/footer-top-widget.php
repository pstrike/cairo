<?php
$footerwidgetcolumn = ot_get_option('footer_top_area', 'onecolumns');

// Widget Footer One Columns
if ($footerwidgetcolumn == 'onecolumns') { ?>
<div class="col-md-12 col-sm-12 col-xs-12">
  <?php dynamic_sidebar("cairo_footer_top_1"); ?>
</div>
<?php }
...
<div class="col-md-6 col-sm-12 col-xs-12">
  <?php
  $footersidebarOne = dynamic_sidebar("cairo_footer_top_1");
...
<div class="col-md-6 col-sm-12 col-xs-12">
  <?php
  $footersidebarTwo = dynamic_sidebar("cairo_footer_top_2");
...
<div class="col-md-4 col-sm-12 col-xs-12">
  <?php
  $footersidebarTheree = dynamic_sidebar("cairo_footer_top_3");
...
<div class="col-md-3 col-sm-12 col-xs-12">
  <?php
  $footersidebarFour = dynamic_sidebar("cairo_footer_top_4");
