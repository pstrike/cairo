...
<section class="featured-post-slider">
	<div class="container">
		<div class="featured-block">
			<ul class="featured-slider-posts featured-style-1 codepages-loading">
			<?php
			$i = 0;
			...
			if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); $i++?>
				...
				?>
				<?php if($i % 4 == 1) {
				echo '<div class="col-md-6 featured-blocks block-left"><div class="row">';
				 } ?>
				<?php if($i % 4 == 2) {
				echo '<div class="col-md-6 featured-blocks block-right-larg"><div class="row">';
				 } ?>
				<?php if($i % 4 == 3) {
				echo '<div class="col-md-6 featured-blocks block-right-small"><div class="row">';
				 } ?>
				<?php
				if ($i % 4 == 1 || $i % 4 == 2){
					echo '<div class="col-md-12 col-sm-12 col-xs-12"><div class="featured-posts-larg">';
				}
				elseif ($i % 4 == 3 || $i % 4 == 0) {
					echo '<div class="col-md-6 col-sm-12 col-xs-12"><div class="featured-posts-small">';
				}
				?>
				<article <?php post_class('post post-overlay'); ?> role="article">
					...
					elseif ($i % 4 == 3 || $i % 4 == 0) { ?>
						<figure class="post-image">
							<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>">
 							 <?php the_post_thumbnail('cairo-post-small-three', array('itemprop'=>'image')); ?>
 						 </a>
						</figure>
					<?php } ?>
			...
			<?php
		     // if multiple of 3 close div and open a new div
			  if($i % 4== 0 && $i < $cairo_category_featured_post_count-1) { echo '</div><li><div class="featured-posts">';}
				; endwhile;
