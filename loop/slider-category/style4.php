...
<section class="featured-post-slider">
	<div class="container">
		<div class="featured-block">
			<ul class="featured-slider-posts featured-style-4">
				<?php
				...
				if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); $i++?>
					...
					?>
					<?php if($i % 5 == 1) {
					echo '<div class="featured-blocks block-left-small col-md-3 col-sm-12 col-xs-12 ">';
					 } ?>

					<?php if($i % 5 == 4) {
					echo '<div class="featured-blocks block-right-small col-md-3 col-sm-12 col-xs-12">';
					 } ?>

					<?php if($i % 5 == 3) {
					echo '<div class="featured-blocks block-center-larg col-md-6 col-sm-12 col-xs-12">';
					 } ?>
					...
					elseif ($i % 5 == 1 || $i % 5 == 2 || $i % 5 == 4 || $i % 5 == 0) {
						echo '<div class="col-md-12 col-sm-12 col-xs-12"><div class="featured-posts-small">';
					}
					?>
